...
namespace mRemoteNG.Tools
{
    public static class PuttyTypeDetector
    {
        ...
        private static PuttyType GetPuttyType(string filename)
        {
        ...
        {
            return FileVersionInfo.GetVersionInfo(filename).InternalName.Contains("PuTTY");
        }

        private static bool IsPuttyNg(string filename)
        {
            return FileVersionInfo.GetVersionInfo(filename).InternalName.Contains("PuTTYNG");
        }
